...
class RedmineTags::Patches::IssueTest < ActiveSupport::TestCase
  ...
  test "available tags should return list of distinct tags" do
    assert_equal 9, Issue.available_tags.to_a.size
  end

  test "available tags should allow list tags of open issues only" do
    assert_equal 5, Issue.available_tags(:open_only => true).to_a.size
  end
  ...
  test "available tags should allow list tags of specific project only" do
    ...
    assert_equal 4, Issue.available_tags(:project => @project_b).to_a.size

    assert_equal 3, Issue.available_tags(:open_only => true, :project => @project_a).to_a.size
  ...
  test "available tags should allow list tags found by name" do
    assert_equal 5, Issue.available_tags(:name_like => 'a').to_a.size
    assert_equal 4, Issue.available_tags(:name_like => 'b').to_a.size
    assert_equal 1, Issue.available_tags(:name_like => 'a1').to_a.size
    assert_equal 1, Issue.available_tags(:name_like => 'a2').to_a.size

    assert_equal 5, Issue.available_tags(:name_like => 'a', :project => @project_a).to_a.size
    assert_equal 0, Issue.available_tags(:name_like => 'b', :project => @project_a).to_a.size
    assert_equal 3, Issue.available_tags(:name_like => 'a', :open_only => true, :project => @project_a).to_a.size
    assert_equal 0, Issue.available_tags(:name_like => 'b', :open_only => true, :project => @project_a).to_a.size
  end
end
